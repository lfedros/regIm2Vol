...
target_plane.img_G = interp2(plane.micronsY', plane.micronsX, plane.img_G, q.y_vec', q.x_vec, 'linear',0);
end

if isfield(plane, 'img_R');
target_plane.img_R = interp2(plane.micronsY', plane.micronsX, plane.img_R, q.y_vec', q.x_vec, 'linear',0);
end
